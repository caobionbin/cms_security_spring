 ...
 * role操作类
 * 
 * 项目名称：base_spring_framework 类名称：RoleService 类描述： 创建人：huangx 创建时间：2015年1月27日
 * 下午7:02:54 修改人：huangx 修改时间：2015年1月27日 下午7:02:54 修改备注：
 * 
 * @version 1.0
 * 
 */
public interface RoleService {
	/**
	 * 
	 * @Title: 增加Role @Description: 新增角色 @param: role Role对象 @return: void
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: updateRole @Description: 更新角色 @param: role @return @throws
	 */
	...
	/**
	 * 
	 * @Title: deleteRole @Description: 刪除角色 @param: roleId 角色ID @return: void
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: deleteRoles @Description: 刪除角色 @param: roleIds 角色IDs @return:
	 * void 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: findRolesByLoginName @Description: 查询role @param: loginName
	 * 登录名 @return: Role Role对象 @throws
	 */
	 ...
	 * 查询所有有效角色
	 * 
	 * @Title: findAllRole @Description: 查询所有有效角色 @return List<Role>
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: findRolesByFunctIonId @Description: 根据functionId查询roleId @param:
	...
	/**
	 * 
	 * @Title: findRoleList @Description: 查询所有角色 @param tempMap 查询条件 @param:
	 * pageNum 当前页 @param: pageSize 每页显示数量 @return: PageInfo<Role> 返回类型 @throws
	 */
	 ...
	 * 角色ID @return: List<Integer> 返回类型 @throws
	 */
