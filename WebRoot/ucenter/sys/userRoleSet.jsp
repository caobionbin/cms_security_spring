...
<body>
	...
	<div class="rounded table">
		...
		<form:form id="form1" commandName="userInfo"
			action="${pageContext.request.contextPath}/user/saveUserRole.do"
			method="post">
			<table class="update" cellpadding="0" cellspacing="1" border="0">
				<tbody>
					<tr>
						<td class="name">用户名称：</td>
						<td>${userInfo.userName }<input type="hidden" name="id"
							value="${userInfo.id}" />
						</td>
					...
					<tr class="even">
						...
						<td><form:checkboxes items="${allRoles }" path="roles"
								itemValue="id" itemLabel="roleName" delimiter="&nbsp;" /></td>
