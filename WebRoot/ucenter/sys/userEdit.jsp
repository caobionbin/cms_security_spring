...
<body>
	...
	<div class="rounded table">
		...
		<form id="form1" action="<s:url value='/user/updateUser.do'/>"
			method="post">
			<table class="update" cellpadding="0" cellspacing="1" border="0">
				<tbody>
					<tr>
						<td class="name">用户名称：</td>
						<td><input name="displayName" type="text"
							value="${userEntity.displayName }" size="25" maxlength="11"
							class="input rounded" /> <form:hidden path="userEntity.id" /></td>

					</tr>

					<tr class="even">
						<td class="name">用户密码：</td>
						<td><form:password path="userEntity.passWord"
								cssClass="input rounded" size="25" /> <img title="如果不修改密码，请留空"
							class="title2div"
					...
					<tr class="even">
						...
						<td><form:select path="userEntity.state">
								<form:option value="1" label="启用" />
								<form:option value="0" label="禁用" />
							</form:select> <img title="只有当用户状态为启用时，用户才能登录" class="title2div"
							src="<s:url value='/css/images/operation/help.png'/>" width="16"
							height="16" /></td>
